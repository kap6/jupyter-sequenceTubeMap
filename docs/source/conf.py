...
# -*- coding: utf-8 -*-
#
# katana_seqtubes documentation build configuration file
#
...
project = 'katana_seqtubes'
copyright = '2021, kamesh peri'
author = 'kamesh peri'
...
_version_py = os.path.join(repo, 'katana_seqtubes', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'katana_seqtubesdoc'
...
latex_documents = [
    (master_doc, 'katana_seqtubes.tex', 'katana_seqtubes Documentation',
     'kamesh peri', 'manual'),
]
